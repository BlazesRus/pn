...
namespace TextClipCreator
{
    ...
    {
        private const string UserDataDirectory = @"Echo Software\PN2";
        ...
        private Clips _clips = null;
        private readonly ClipStorage _cs = new ClipStorage();
        ...
        public MainForm()
        {
            ...
            this.openFileDialog.InitialDirectory = GetUserDataPath();
            this.saveFileDialog.InitialDirectory = GetUserDataPath();
        }
        ...
        private void InitializeComponent()
        {
            ...
            // lstClips
            // 
            this.lstClips.Anchor = ((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)
            ...
            this.txtClipText.Anchor = (((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)
                | System.Windows.Forms.AnchorStyles.Left)
                | System.Windows.Forms.AnchorStyles.Right);
            this.txtClipText.Font = new System.Drawing.Font("Courier New", 8F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
            ...
            // btnDiscard
            // 
            this.btnDiscard.Anchor = (System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right);
            ...
            // txtClipName
            // 
            this.txtClipName.Anchor = ((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
                | System.Windows.Forms.AnchorStyles.Right);
        ...
        {
            e.Cancel = this.CheckModified() == false;
        }

        private void lstClips_SelectedValueChanged(object sender, System.EventArgs e)
        {
            if (this.lstClips.SelectedItem != null)
            {
                this._changing = true;
                Clip theClip = (Clip)this.lstClips.SelectedItem;
                this.txtClipText.Text = theClip.Content;
                this.txtClipName.Text = theClip.Name;
                this._changing = false;
            }

            this.enableButtons(this._editing);
        }
        ...
        private void maybeBeginEdit()
        {
            if (this.lstClips.SelectedItem != null && this.lstClips.Enabled && !this._changing)
            {
        ...
        {
            if (this.lstClips.SelectedItem != null && !this.lstClips.Enabled)
            {
                Clip theClip = (Clip)this.lstClips.SelectedItem;

                foreach (Clip otherClip in this._clips.TextClips)
                {
                    if (otherClip != theClip && otherClip.Name == this.txtClipName.Text)
                    {
                        this.errorProvider.SetIconAlignment(this.txtClipName, ErrorIconAlignment.MiddleLeft);
                        this.errorProvider.SetError(this.txtClipName, "Must have a unique clip name");
                        return;
                    }
                }

                theClip.Name = this.txtClipName.Text;
                theClip.Content = this.txtClipText.Text;

                this.errorProvider.SetError(this.txtClipName, "");

                this.enableButtons(false);

                // Force reset of clip data...
                this.lstClips.Items[this.lstClips.SelectedIndex] = theClip;

                this._clips.Modified = true;
            }
        }
        ...
        private void itmOpen_Click(object sender, System.EventArgs e)
        {
                ...
                this.openFileDialog.ShowDialog(this) == DialogResult.OK)
            {
                ...
                try
                {
                    clips = this._cs.Load(this.openFileDialog.FileName);
                }
                catch (Exception)
                {
                }
                ...
                {
                    this._clips = clips;
                    foreach (Clip c in this._clips.TextClips)
                    {
                        this.lstClips.Items.Add(c);
                    }

                    this.setName.Text = clips.Name;
        ...
        private bool haveClip(string name)
        {
            foreach (Clip c in this._clips.TextClips)
            {
                if (c.Name == name)
        ...
        private string getGoodNewClipName()
        {
            int clip = 0;
            while (true)
            {
        ...
        private void btnAdd_Click(object sender, System.EventArgs e)
        {
            ...
            Clip c = new Clip(this.getGoodNewClipName());
            this._clips.TextClips.Add(c);
            this.lstClips.Items.Add(c);
            this.lstClips.SelectedItem = c;
        }
        ...
        private void setName_TextChanged(object sender, System.EventArgs e)
        {
            ...
            this._clips.Name = this.setName.Text;
        }
        ...
        private void btnRemove_Click(object sender, System.EventArgs e)
        {
            if (this.lstClips.SelectedItem != null)
            {
                this.lstClips.Items.Remove(this.lstClips.SelectedItem);
                this.txtClipName.Text = "";
                this.txtClipText.Text = "";
            }
        }

        private void enableButtons(bool editing)
        {
            this._editing = editing;
            this.lstClips.Enabled = !editing && this._clips != null;
            this.btnAdd.Enabled = !editing;
            this.btnRemove.Enabled = !editing && this.lstClips.SelectedItem != null;

            this.btnUpdate.Enabled = editing;
            this.btnDiscard.Enabled = editing;

            this.itmSaveAs.Enabled = this._clips != null && !this._editing;
            this.itmSave.Enabled = !this._editing && this._clips != null && this._filename != "" && this._filename != null;

            if (editing == true)
            {
                this.txtClipText.Focus();
            }
            else
            {
                this.lstClips.Focus();
        ...
        {
            if (this._filename != "" && this._filename != null && this._clips != null)
            {
                this.Save(false);
            }
        }
        ...
        {
            bool res = true;
            if (this._clips != null && this._clips.Modified == true)
            {
                DialogResult dr = MessageBox.Show(this,
                    string.Format("Save changes to {0}?", this._filename),
