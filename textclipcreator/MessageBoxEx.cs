...
namespace TextClipCreator
{
    ...
    public class MessageBoxEx : System.Windows.Forms.Form
    {
        ...
        internal MessageBoxEx(string instruction, string details, string commit1, string commit2, MessageBoxIcon icon)
        {
            ...
            this.btnCommit1.Text = commit1;
            this.btnCommit2.Text = commit2;
            switch (icon)
            {
                case MessageBoxIcon.Asterisk:
                    this.pictureBox.Image = SystemIcons.Asterisk.ToBitmap();
                    break;
                case MessageBoxIcon.Error:
                    this.pictureBox.Image = SystemIcons.Error.ToBitmap();
                    break;
                case MessageBoxIcon.Exclamation:
                    this.pictureBox.Image = SystemIcons.Exclamation.ToBitmap();
                    break;
        ...
        private void InitializeComponent()
        {
            ...
            // lblInstruction
            // 
            this.lblInstruction.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0);
            ...
            // btnCommit1
            // 
            this.btnCommit1.Anchor = (System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right);
            ...
            // btnCommit2
            // 
            this.btnCommit2.Anchor = (System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right);
        ...
        public static MessageBoxExResult Show(Form owner, string caption, string instruction, string details, string commit1, string commit2, MessageBoxIcon icon)
        {
